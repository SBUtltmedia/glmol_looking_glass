     ...
     return true;
        ...
        GLmol.prototype.drawAtomsAsIcosahedron = function(group, atomlist, defaultRadius, forceDefault) {
          ...
          for (var i = 0; i < atomlist.length; i++) {
            ...
            console.log('THIS IS  ' + defaultRadius)
        ...
        GLmol.prototype.defineRepresentation = function() {
          var schema= {
            ...
            line:  false, //Side chains as lines: true, false
            doNotSmoothen:  true, //Don't smooth beta-sheets in ribbons: true, false
            nb:  'none', //Non-bonded atoms as: nb_sphere, nb_cross, none
            hetatmMode: 'sphere', //Small molecules (HETATMS) as: stick, ballAndStick, ballAndStick2, sphere, icosahedron, line, none
            cell:   false, //Unit cell: true, false
            biomt:   false, //Biological assembly: true, false
            packing:   false, //Crystal packing: true, false
            symopHetatms:  false //Show HETATMS in symmetry mates: true, false
          }
          var all = this.getAllAtoms();
          var hetatm = this.removeSolvents(this.getHetatms(all));
        ...
        //  this.getChain(all, biomtChains);
          this.drawColor(schema.color.defalt);
